...
//        }
        try {
            ...
            printer.print(bean.getChannel_name()+"  #"+bean.getShop_tml_num());

            printer.printLineFeed(1);
            printer.print("  "+bean.getOrderType());
            printer.printLineFeed(1);

            printer.setFontSize(0);
            printer.print(""+bean.getSub_unit_name());
            ...
            printer.setFontSize(0);
            printer.print("门店序号：");
            printer.print("#"+bean.getShop_total_num() );
...
//            Bitmap bitmap = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.wechat);
            ...
            if(bean.bitmap!=null){
                printer.setAlignCenter();
                printer.printBitmapV2(bean.bitmap,true);
            }
